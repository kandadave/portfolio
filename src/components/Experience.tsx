  ...
  return (
    <section id="experience" className="py-20 md:py-28 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Timeline Stream */}
        <div className="space-y-8 relative before:absolute before:inset-0 before:left-3.5 sm:before:left-5 before:w-0.5 before:bg-slate-200">
          {experienceData.map((item) => (
            <div key={item.id} className="relative pl-10 sm:pl-14">
              
              {/* Timeline Indicator Dot */}
              <div className="absolute left-1.5 sm:left-3 top-1.5 w-4 h-4 rounded-full bg-emerald-600 border-4 border-white shadow-xs" />
